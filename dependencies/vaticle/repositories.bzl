...
def vaticle_typedb_client_java():
    git_repository(
        ...
        commit = "6a7571216c56068e11a97d66e63794af127b0980",  # sync-marker: do not remove this comment, this is used for sync-dependencies by @vaticle_typedb_client_java
    )
